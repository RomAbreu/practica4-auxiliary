...
java -jar ~/practica4-auxiliary/app1/build/libs/app.jar > ~/practica4-auxiliary/app1/build/libs/salida.txt 2> ~/practica4-auxiliary/app1/build/libs/error.txt &
...
# Subiendo la aplicación puerto por defecto.
java -jar ~/practica4-auxiliary/app2/build/libs/app.jar > ~/practica4-auxiliary/app2/build/libs/salida.txt 2> ~/practica4-auxiliary/app2/build/libs/error.txt &
